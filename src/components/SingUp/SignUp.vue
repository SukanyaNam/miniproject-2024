            ...
            <div class="col-md-5 mb-1">
                <div class="card shadow">
                    <div class="card-header p-0">
                        <img src="https://i.pinimg.com/564x/8b/29/2a/8b292a733fdfa13083d6b20cd2684fca.jpg"
                            class="card-img-top" alt="sign">
                    </div>
                    <div class="card-body">
                        <p class="card-text text-end">7 ที่เที่ยวเวียดนาม 2024.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form @click.prevent>
                            ...
                            <div class="mb-2">
                                <p type="submit" @click="submitForm" class="btn btn-danger shadow d-block">สมัครสมาชิก</p>
