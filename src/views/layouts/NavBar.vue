...
<template>
    <nav class="navbar navbar-expand-lg navbar-dark shadow" style="background: #ed5e11;">
        <div class="container">
            <RouterLink :to="{ name: 'home' }" class="navbar-brand">7 ที่เที่ยวเวียดนาม</RouterLink>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="bi bi-bank2 me-1"></i>ที่เที่ยวเวียดนาม
                        </a>

                        <ul class="dropdown-menu">
                            <li>
                                <RouterLink :to="{ name: 'wonders' }" class="dropdown-item">ที่เที่ยวเวียดนาม
                                </RouterLink>
                            </li>
                            <li>
                                <RouterLink :to="{ name: 'add-wonder' }" class="dropdown-item">เพิ่มที่เที่ยวเวียดนาม
                                </RouterLink>
                            </li>
                            <li><a class="dropdown-item" href="#">แก้ไขที่เที่ยวเวียดนาม</a></li>
                            <li><a class="dropdown-item" href="#">ลบที่เที่ยวเวียดนาม</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="https://www.uptomego.com/danang-vietnam/">เว็บไซต์ ที่เที่ยวเวียดนาม</a></li>
                        </ul>
                    </li>
